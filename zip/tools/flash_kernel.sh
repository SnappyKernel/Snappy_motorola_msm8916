...
./mkbootimg --kernel /tmp/zImage --ramdisk /tmp/boot.img-ramdisk.gz --cmdline "console=ttyHSL0,115200,n8 androidboot.console=ttyHSL0 androidboot.hardware=qcom msm_rtb.filter=0x237 ehci-hcd.park=3 androidboot.bootdevice=7824900.sdhci lpm_levels.sleep_disabled=1 androidboot.selinux=permissive sched_enable_hmp=1 phy-msm-usb.floated_charger_enable=1 buildvariant=userdebug"  --base 0x80000000 --pagesize 2048 --ramdisk_offset 0x82000000 --tags_offset 0x81e00000 --dt /tmp/dt.img -o /tmp/newboot.img
